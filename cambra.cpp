...
cambra::cambra(const cambra & c) throw(error){
  ...
  /*POST: Copiem la cambra per p.i a la nostra*/
...
cambra & cambra::operator=(const cambra & c) throw(error){
  /*PRE: Ens passen per paràmetre una cambra c*/
  /*POST: Retorna l'assignació de la cambra passada per p.i a la nostra*/
...
bool cambra::operator==(const cambra & c) const throw(){
  /*PRE: Ens passen per paràmetre una cambra c*/
  /*POST: Retorna true en cas que l'array de portes de la cambra passada per p.i
